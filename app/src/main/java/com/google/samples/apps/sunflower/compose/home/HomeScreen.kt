...
fun HomeScreen(
    ...
    val gardenPlantingListViewModel: GardenPlantingListViewModel = hiltViewModel()
    val plantListViewModel: PlantListViewModel = hiltViewModel()
